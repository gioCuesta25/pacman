...
/*x1 */             {30, 30, 30,  8, 26, 26, 26, 26, 26, 26, 26, 26,  9, 30, 30, 30,  8, 30,  9, 30, 30, 30,  8, 26, 26, 26, 26, 11, 10, 26, 26, 26, 26,  9, 30, 30},
...
/*x26 */            {30, 30, 30,  8, 26, 26, 26, 26, 26, 26, 26, 26,  9, 30, 30, 30,  8, 30,  9, 30, 30, 30,  8, 26, 26, 26, 26, 11, 10, 26, 26, 26, 26,  9, 30, 30},
/*x27 */            {30, 30, 30,  4, 12, 12, 12, 12, 12, 12, 12, 12,  5, 30, 30, 30,  8, 30,  9, 30, 30, 30,  4, 12, 12, 12, 12, 25, 20, 12, 12, 12, 12,  5, 30, 30}}
{

}

int Laberinto::getPieces(int x, int y) const
{
    return pieces[x][y];
}

bool Laberinto::pieceBlocks(int x, int y)
{
    return pieces[x][y] != NONE_FIELD && pieces[x][y] != SMALL_DOT_FIELD && pieces[x][y] != BIG_DOT_FIELD;
}

/*
- 26: numero que representa las piezas comestibles
- 27: numero que representa las piezas comstibles de mayor valor
*/
